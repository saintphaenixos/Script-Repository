...
sh /usr/pkgsrc/sysutils/sysupgrade fetch https://cdn.NetBSD.org/pub/NetBSD/NetBSD-$BSDVer/amd64
sh /usr/pkgsrc/sysutils/sysupgrade kernel
sh /usr/pkgsrc/sysutils/sysupgrade modules
sh /usr/pkgsrc/sysutils/sysupgrade sets
sh /usr/pkgsrc/sysutils/sysupgrade etcupdate
sh /usr/pkgsrc/sysutils/sysupgrade postinstall
sh /usr/pkgsrc/sysutils/sysupgrade clean
reboot
