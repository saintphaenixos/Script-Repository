...
(( $Systemmem < 1.7 )) && fuchsia "The Nix Package Manager's memory requirements exceed installed amount, please install greater than 4 Total Gigabytes of Memory." && fuchsia "Exiting Installation." && exit 1
