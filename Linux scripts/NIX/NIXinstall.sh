...
(( $Systemmem < 4 )) && fuchsia "memory requirements exceed installed amount, please install greater than 4 Total Gigabytes of Memory." && fuschia "Exiting Installation." && Exit 1
