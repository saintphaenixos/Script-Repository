...
targetsoftware=$(osascript -e 'Tell application "System Events" to display dialog "Please Enter A Name For The Software to be removed \n e.g Adobe, Microsoft, or other." default answer ""' -e 'text returned of result' 2>/dev/null)
